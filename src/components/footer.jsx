    ...
    <footer className="bg-black text-white py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start space-y-6 md:space-y-0">
          ...
          {/* Column 2: Quick Links */}
          <div className="flex flex-col mobile:w-full w-[150px] items-center text-start mobile:text-center gap-2 mobile:items-center space-y-2">
            <h3 className="text-lg font-semibold">About</h3>
            <ul className="space-y-3">
              <li><Link to="/" className="text-gray-300 hover:text-yellow-400">Phone: +2348029902223</Link></li>
              <li><Link to="/about" className="text-gray-300 hover:text-yellow-400">Address: No.16 Nwanonye street off Asaba Benin express way by KIA motors, DLA road, Asaba Nigeria</Link></li>
              <li><Link to="/contact" className="text-gray-300 hover:text-yellow-400">Contact</Link></li>
            </ul>
          </div>
          <hr className='w-full h-[1px] bg-slate-500 hidden mobile:flex'/>
