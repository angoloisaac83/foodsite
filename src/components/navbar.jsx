        ...
        <nav className="bg-green-400 z-[100] shadow-xl fixed top-0 left-0 w-full h-fit text-white p-2">
            <div className="container flex justify-between items-center">
                ...
                <ul className="flex mobile:hidden space-x-6 items-center">
                    ...
                    <li><Link to="/menu" className="hover:text-yellow-500 hover:underline">Menu</Link></li>
                    <li><Link to="/category" className="hover:text-yellow-500 hover:underline">Category</Link></li>
                    ...
                    <li>
                        <Link to="/account" className="hover:text-yellow-500 flex items-center">Account</Link>
                    </li>      
                    </span>
